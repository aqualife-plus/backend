...
public class CustomTempDeserializer extends JsonDeserializer<Double> {
    ...
    public Double deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (value == null || value.trim().isEmpty()) {
            throw new CustomDeserializeException(key, "temp 설정값이 필요합니다.");
        }
        ...
        if (0 > doubleValue || doubleValue > 100) {
            throw new CustomDeserializeException(key, "0 ~ 99.9 사이값이여야 합니다.");
        }
