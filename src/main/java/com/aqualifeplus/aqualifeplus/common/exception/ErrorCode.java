...
public enum ErrorCode {
    ...
    ERROR_DO_CREATE_400_OR_500_IN_REALTIME_FIREBASE("firebase RealTime DB에서 Create중 Error가 발생했습니다.", HttpStatus.BAD_REQUEST),
    ERROR_DO_UPDATE_400_OR_500_IN_REALTIME_FIREBASE("firebase RealTime DB에서 Update중 Error가 발생했습니다.", HttpStatus.BAD_REQUEST),
    ERROR_DO_DELETE_400_OR_500_IN_REALTIME_FIREBASE("firebase RealTime DB에서 Delete중 Error가 발생했습니다.", HttpStatus.BAD_REQUEST),
    ERROR_DO_LOAD_400_OR_500_IN_REALTIME_FIREBASE("firebase RealTime DB에서 Load(Get)중 Error가 발생했습니다.", HttpStatus.BAD_REQUEST),
    UNEXPECTED_ERROR_IN_REALTIME_FIREBASE("Firebase RealTime DB에서 예상치 못한 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    NULL_ERROR_FISHBOWL_TOKEN("fishbowl token가 존재하지 않습니다.", HttpStatus.NOT_FOUND),
    FAIL_FIREBASE_CREDENTIALS("Firebase 자격 증명에서 액세스 토큰을 가져오지 못했습니다", HttpStatus.NO_CONTENT),
